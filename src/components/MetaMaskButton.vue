<template>
<button v-bind:disable="isSignedInMetaMask" type="button" class="btn-metamask" v-on:click="loginMetaMask">
  <span class="btn-metamask__icon">
    <!-- <svg version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 318.6 318.6" style="enable-background:new 0 0 318.6 318.6;" xml:space="preserve"> -->
    <!-- <svg viewBox="0 0 318.6 318.6"> -->
  ...
  <span v-if="isSignedInMetaMask" class="btn-metamask__text">Signed</span>
  <span v-else class="btn-metamask__text">Sign in with MetaMask</span>
</button>
</template>
